        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            {{-- <li class="nav-item">
                ...
                <div id="products" class="collapse">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" >Bulk Update</a>
                        <a class="collapse-item" >Single Update</a>
            ...
            <!-- Sidebar Message -->
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#profile"
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" style="box-shadow: none"
                                placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="button"style="box-shadow: none">
