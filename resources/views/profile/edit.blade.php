    ...
    <div class="container pt-4 col-lg-10 col-md-10 col-sm-6 ">
        <div class="row mb-4 pt-4">
            <div class="col-lg-12 col-md-10 col-sm-6">
                <h1 class="h3">Assign Roles | New User</h1>
                @if(session('success'))
                        ...
                        <form action="{{ route ('profile.new_user')}}" method="POST" id="adminEditForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="phoneNumber" id="phoneNumber" placeholder="+ 94" value="" >
                            ...
                            <div class="row">
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Email" autocomplete="new-email" value="" >
                                    @if ($errors->has('email'))
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="password" class="form-control" name="userPassword" id="userPassword" placeholder="Password" autocomplete="new-password" value="" >
        ...
        <div class="offcanvas-body">
            <form action="{{route('user.save')}}" method="POST" id="editUserForm" >
                ...
                <div class="row align-items-center justify-content-center">
                    <button type="submit" class="btn btn-success col-4 mb-3 btn-sm me-4"  data-bs-dismiss="offcanvas">Update</button>
                    <button type="button" class="btn btn-danger col-4 mb-3 btn-sm" id="deleteUserBtn" data-bs-dismiss="offcanvas">Delete</button>
                </div>
            </form>
        </div>
    </div>
