...
@section('content')
    ...
    @vite(['resources/js/roles/roles.js', 'resources/js/app.js'])

    <div class="container mt-5 col-lg-10 col-md-10 col-sm-6">
        <div class="row mb-4 pt-4">
            <div class="col-lg-12 col-md-10 col-sm-6">
                <h1 class="h3 text-gray-800">Grant Permissions</h1>
                @if (session('success'))
            ...
            <div class="card-body">
                ...
                <form action="{{ route('profile.rolesave') }}" method="POST" id="permissionsForm">
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-success mt-3" id="updatePermissions">Update
                            Permissions</button>
                    </div>
